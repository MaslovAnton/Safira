...
Gem::Specification.new do |s|
  ...
  s.files = ["examples/eventmachine.rb", "examples/threaded.rb", "spec/em/em_fiber_spec.rb", "spec/em/em_spec.rb", "spec/mysql2/client_spec.rb", "spec/mysql2/error_spec.rb", "spec/mysql2/result_spec.rb", "spec/rcov.opts", "spec/spec_helper.rb", "ext/mysql2/extconf.rb"]
