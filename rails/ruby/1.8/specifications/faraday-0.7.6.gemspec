...
Gem::Specification.new do |s|
  ...
  s.files = ["test/adapters/live_test.rb", "test/adapters/logger_test.rb", "test/adapters/net_http_test.rb", "test/adapters/test_middleware_test.rb", "test/adapters/typhoeus_test.rb", "test/connection_test.rb", "test/env_test.rb", "test/helper.rb", "test/live_server.rb", "test/middleware_stack_test.rb", "test/request_middleware_test.rb", "test/response_middleware_test.rb"]
  ...
  s.test_files = ["test/adapters/live_test.rb", "test/adapters/logger_test.rb", "test/adapters/net_http_test.rb", "test/adapters/test_middleware_test.rb", "test/adapters/typhoeus_test.rb", "test/connection_test.rb", "test/env_test.rb", "test/helper.rb", "test/live_server.rb", "test/middleware_stack_test.rb", "test/request_middleware_test.rb", "test/response_middleware_test.rb"]
